    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget white-bg">
                ...
                <form action="/backUpdateCoach.html" class="templatemo-login-form" method="post">
                    <div class="row form-group">
                        <div class="col-lg-6 col-md-6 form-group">
                            ...
                            <label>出生日期</label>
                            <input type="date" class="form-control" name="coachBirth" value="${coach.coachBirth}">
                            <label>入职日期</label>
                            <input type="date" class="form-control" name="coachEntrydate"
                                   value="${coach.coachEntrydate}">
                            <br>性别：
                            <input type="radio" name="gender" id="1" value="男"
                                   <c:if test="${coach.gender eq '男'}">checked="checked"</c:if>>
                            <label for="1" class="font-weight-400"><span></span>男</label>
                            <input id="2" type="radio" name="gender" value="女"
                                   <c:if test="${coach.gender eq '女'}">checked="checked"</c:if>>
                            <label for="2" class="font-weight-400"><span></span>女</label>
                        </div>
                    </div>
